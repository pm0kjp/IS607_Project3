...
The input data is from [link](https://github.com/pm0kjp/IS607_Project3/blob/master/data/tidy_oscar_winners.csv). The 1's indicate winning the award, 0's indicate not winning.
...
```{r}
library(XML)
oscar_data <- readHTMLTable('tidy_oscar_winners.csv.html')
