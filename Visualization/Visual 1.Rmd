...
#Scatter Plot2
ggplot(data = Oscar_table2, aes(y = Best_Directing, x = Best_Picture))+ geom_point(aes(color = Year)) + theme_igray() + ggtitle("Oscar's Winners Best Picture Vs Best Directing") + ylab("Won Best Directing Pictures") + xlab("Won Best Pictures") + scale_y_discrete(labels=abbreviate) + scale_x_discrete(labels=abbreviate) + theme(axis.text.x= element_text(angle=90)) 
